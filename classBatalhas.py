...
class Batalha:
    def __init__(self):
        ...
        self.lista_imagens = [
            ...
            pygame.transform.scale((pygame.image.load('img/pikachulivre.png')),(150,150)),
            pygame.transform.scale((pygame.image.load('img/charmander.png')),(200,200))
        ]
        self.vida_jogador = 200
        self.vida_j_max = 200
        self.botao = 1
    ...
    def desenha_batalha(self, window, dicionario):
        ...
        blit_inimigo = self.fonte.render(f'PIKACHU: {dicionario["vida_pokemon"]}/{dicionario["vidamax_pokemon"]}', True, (0, 0, 0))
        window.blit(blit_inimigo, (80, 115))
        blit_jogador = self.fonte.render(f'CHARMANDER: {self.vida_jogador}/{self.vida_j_max}', True, (0, 0, 0))
        window.blit(blit_jogador, (350, 310))
        if self.tela_atual == 'texto_batalha':
            window.blit(self.lista_imagens[4], (0, 450))
            ataque1 = self.fonteBatalha.render("CHARMANDER used TACKLE!", True, (0,0,0))
